    ...
    <div className="text-white my-10">
      ...
      <div className="flex flex-col lg:flex-row justify-evenly my-5 text-center">
        <div
          ...
          className=""
        >
          <i className="fa-solid fa-location-dot text-accent text-4xl my-5"></i>
        ...
        <div data-aos="zoom-in-up" data-aos-duration="1200">
          <i className="fa-solid fa-phone text-accent text-4xl my-5"></i>
        ...
        <div data-aos="fade-left" data-aos-duration="1200">
          <i className="fa-solid fa-envelope text-accent text-4xl my-5"></i>
