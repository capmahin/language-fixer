...
const Review = () => {
    ...
    return (
        <div className="bg-accent text-slate-700 py-12">
            <div className="w-96 mx-auto mt-14">
                ...
                <div className="form-control mt-4">
                    ...
                    <textarea
                        ...
                        placeholder="Tell us how we could improve ourselves."
                    ></textarea>
                    <button
                        onClick={handlePostReview}
                        className="bg-primary text-gray-50 px-10 py-2 rounded-lg mt-6 hover:bg-slate-700"
                    >
                        Post Comment
                    </button>
                </div>
            ...
            <img
                className="pt-12 absolute w-screen"
                src={borderAccent}
                alt=""
            />
        </div>
