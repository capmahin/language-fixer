    ...
    return (
        <div>
            ...
            <ul className="menu p-4 overflow-y-auto w-44 lg:w-80 ">
                ...
                <label for="my-modal-5" className='btn btn-outline border-0 my-2 text-base text-gray-500' ><img className='mr-2' src={newclass} alt="" /> Add Students</label>
                ...
                <div class="modal">
                    <div class="modal-box w-11/12 max-w-5xl">
                        <h3 class="font-bold text-lg py-3">Let's add students to your class.</h3>
                        ...
                        <div class="overflow-x-auto">
                            <table class="table table-zebra w-full">
                                ...
                                <tbody>
                                    ...
                                    {users?.filter(user => !user.className && !user.language)?.map((u, index) =>
                                        <tr>
                                            <th>{index + 1}</th>
                                            <td>{u.email}</td>
                                            <td>
                        ...
                        <div class="modal-action">
                            <label for="my-modal-5" class="btn bg-accent my-5 border-0 text-white rounded-full w-44 hover:bg-white hover:text-accent hover:border-accent hover:border-2 modal-button">Done!</label>
                        </div>
                    </div>
                </div>
